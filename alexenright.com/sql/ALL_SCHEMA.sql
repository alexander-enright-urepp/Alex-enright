-- =====================================================
-- COMPLETE SQL - Run everything in Supabase
-- Order: News → Scores → Community
-- =====================================================
...
-- News Unique Constraint (for upsert)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Contact Forms (Hire Alex + Job Applications)
